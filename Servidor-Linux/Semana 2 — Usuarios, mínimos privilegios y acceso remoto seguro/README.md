...
Aplicación del principio de mínimos privilegios mediante sudo.

Configuración de SSH seguro para acceso remoto.

Activación y endurecimiento del firewall UFW.

Pruebas controladas de acceso permitido y denegado.
